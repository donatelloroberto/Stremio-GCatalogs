/**
 * Vercel-specific build: compiles the Express app to a single serverless-compatible bundle.
 * Entry: src/vercel.ts (exports app without listen)
 * Output: ../../api/dist/server.mjs (consumed by /api/server.mjs)
 */
